    ...
    <div class="row justify-content-center">
      <div class="col-md-8 col-lg-6 col-xl-5">
            ...
            <div class="row">
              <div class="col-7">
                <div class="text-primary p-4">
                  ...
                  <p>Sign in to continue to Slum.</p>
                </div>
              </div>
              ...
              <router-link tag="a" to="/">
                <div class="avatar-md profile-user-wid mb-4">
                  <span class="avatar-title rounded-circle bg-light">
                    <img src="@/assets/images/logo-light-sm.png" alt height="34" />
                  </span>
                </div>
              </router-link>
            </div>
        ...
        <div class="mt-5 text-center">
          ...
          <p>
            © {{new Date().getFullYear()}} Slum. Crafted with
            <i class="mdi mdi-heart text-danger"></i> by Megvii INC.
          </p>
        </div>
        <!-- end row -->
      </div>
